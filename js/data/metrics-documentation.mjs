...
export const METRICS_DOCUMENTATION = [
  ...
  page("jornada", "Jornada", "Mostra o caminho dos clientes pelas etapas do App.", [
    ...
    metric("tempo-rota-patrimonial", "Tempo até Rota Patrimonial", "Tempo típico desde a entrada do cliente até a primeira Rota Patrimonial realizada.", "Conta quantos dias passaram desde a entrada do cliente até a primeira Rota Patrimonial realizada. O número exibido é a mediana: metade dos clientes levou menos tempo e metade levou mais."),
    metric("tempo-ativacao-engrenagens", "Tempo até Ativação das Engrenagens", "Tempo típico desde a entrada do cliente até a primeira Ativação das Engrenagens realizada.", "Conta quantos dias passaram desde a entrada do cliente até a primeira Ativação das Engrenagens realizada. O número exibido é a mediana: metade dos clientes levou menos tempo e metade levou mais."),
    metric("tempo-central-inteligencia", "Tempo até Central de Inteligência", "Tempo típico desde a entrada do cliente até a primeira Central de Inteligência realizada.", "Conta quantos dias passaram desde a entrada do cliente até a primeira Central de Inteligência realizada. O número exibido é a mediana: metade dos clientes levou menos tempo e metade levou mais."),
    metric("nunca-acessaram", "Nunca acessaram", "Clientes cadastrados que ainda não possuem nenhum login registrado no sistema.", "Conta os clientes oficiais cuja data de último login está vazia. O percentual usa a população oficial do recorte como denominador."),
